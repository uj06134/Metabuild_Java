...
public class AlbumsMain {
	...
	private void group() {
		...
		AlbumsBean ab = adao.group(group);
		
		if(ab == null) {
			System.out.println("없는 회사명입니다");
		}
		else {
			System.out.println("회삼명\t앨범가격평균");
	...
	private void align() {
		...
		System.out.print("번호:1  제목:2  가수명:3  번호입력>>");
	...
	private void displayAlbums(ArrayList<AlbumsBean> lists) { // 10
