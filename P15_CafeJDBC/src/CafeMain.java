...
public class CafeMain {
	...
	private void getCountMenu() {
		System.out.println("카페명\t메뉴수");
		ArrayList<CafeBean> lists = cdao.getCountMenu();
		for (int i=0;i<lists.size();i+=1) {
			CafeBean cb = lists.get(i);
			System.out.println(cb.getCname() + "\t" + cb.getCount());
		}
	}
